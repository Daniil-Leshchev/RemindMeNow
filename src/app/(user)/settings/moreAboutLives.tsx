...
export default function MoreAboutLives() {
    ...
    <View style={styles.wrapper}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.settingsContainer}>
          <Image
            source={require('@assets/icons/settings/moreAboutLives/heart.svg')}
            style={{ width: 83, height: 73, marginBottom: 16 }}
          />
          ...
          <Text style={styles.text}>
            Изначально у пользователя есть 10 сердец.
            Каждый день, когда все задачи из списка 
            на день не будут выполнены, одно сердце 
            будет снято.
          </Text>

          <Text style={styles.text}>
            Когда все жизни закончатся, количество 
            звёзд опустится на начало уровня.
          </Text>

          <Text style={styles.text}>
            Будьте внимательны к уровню звёзд и 
            жизней в приложении, чтобы добиться
            максимальных результатов в Вашей повседневной деятельности.
          </Text>
